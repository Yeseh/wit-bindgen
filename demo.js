...
export function render(arg0, arg1, arg2) {
  ...
  const {rustUnchecked: v2_0, wasmtimeTracing: v2_1, jsCompat: v2_2, jsInstantiation: v2_3 } = arg2;
  const ret = exports1.render(enum0, ptr1, len1, v2_0 ? 1 : 0, v2_1 ? 1 : 0, v2_2 ? 1 : 0, v2_3 ? 1 : 0);
  let variant7;
